...
function isObjectValueEqual(obj1, obj2) {
	const in1 = obj1 instanceof Object;
	const in2 = obj2 instanceof Object;
	if (!in1 || !in2) {
		return in1 === in2;
	}
	if (Object.keys(obj1).length !== Object.keys(obj2).length) {
	...
	for (const p in obj1) {
		const a = obj1[p] instanceof Object;
		const b = obj2[p] instanceof Object;
		if (a && b) {
...
const a = { a: 21, c: { age: "name" }, d: [1] };
const b = { a: 21, c: { age: "name" }, d: [1] };
